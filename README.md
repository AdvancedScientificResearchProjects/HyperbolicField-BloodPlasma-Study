...
Каждый образец плазмы идентифицируется кодом вида **`{частота}.{пациент}.{номер}`**.

| Компонент | Значение | Пояснение |
|-----------|----------|-----------|
| Частота | `0` | Контроль — без воздействия излучением |
| | `19` | Воздействие на частоте **19 ГГц** |
| | `21` | Воздействие на частоте **21 ГГц** |
...
- `19.2.1` — образец №1 пациента 02, облучённый на 19 ГГц
- `21.7.2` — образец №2 пациента 07, облучённый на 21 ГГц
...
4. **Облучение** — воздействие гиперболическим полем на частотах 19 и 21 ГГц
